...
* Sys.setlocale("LC_CTYPE", "russian") for handling texts in Russian
* options(stringsAsFactors = F)
* options(error=recover) for debuging
...
* `abline(h = 12)`
* `hist(data, col = "green", breaks = 100)` Here `breaks` sets the number of bars
...
* par() ? see part 2 at 03:58
* Resources: [R Graph Gallery](http://rgraphgallery.blogspot.ru/), [R Bloggers](http://www.r-bloggers.com/)